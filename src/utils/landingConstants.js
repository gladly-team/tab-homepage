...
export const seasLandingProps = {
  ...
  causeData: {
    ...
    subtitle:
      'Every tab opened raises money for #TeamSeas, an internet-led movement raising $30 million to clean up 30 million pounds of trash from our oceans, rivers, and lakes.',
    ...
    headOgDescription:
      "Open browser tabs to clean our seas, for free. It's that easy. Join #teamseas today!",
    headKeywords:
...
export const catsLandingProps = {
  ...
  causeData: {
    ...
    subtitle:
      'Every tab opened raises money for cats in need of a fur-ever home. It’s so easy a cat could do it!',
