...
import { mediumScreenWidth } from 'utils/layout'
...
const IndexPage = () => (
  <MediaQuery maxWidth={mediumScreenWidth}>
    {isSkinnyScreen => {
      return (
        <div>
          <Section wrap={'reverse'}>
            <img
              ...
              style={{
                width: isSkinnyScreen ? '90%' : '67%',
                maxWidth: 700,
                height: isSkinnyScreen ? '90%' : '67%',
                marginTop: 20,
                marginRight: 20,
                marginBottom: 20,
              }}
            ...
            >
              ...
              <p>
                It's easier than putting on socks—and unlike socks, it warms
                your heart.
              </p>
          ...
          <Section>
            ...
            <img
              ...
              style={{
                width: isSkinnyScreen ? '90%' : '60%',
                maxWidth: 700,
                height: isSkinnyScreen ? '90%' : '60%',
                marginTop: 20,
                marginLeft: 20,
                marginBottom: 20,
              }}
          ...
          >
            <div style={{ textAlign: 'center', maxWidth: 760, padding: 10 }}>
              ...
              <div style={{ maxWidth: 560 }}>
                ...
                <p>
                  Even better, we publish quarterly financial reports, so you
                  can see exactly how much we give to each charity and what our
                  other costs are.
                </p>
