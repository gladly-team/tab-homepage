...
function PrivacyPolicyPage({ location }) {
  return (
        ...
        <TextPageContent>
          ...
          <ul>
            ...
            <li>
              ...
              ongoing operation of one of our Services.
            </li>
          </ul>
          <p>
            ...
            for a Cause", "us", "our", or "we") and is part of Gladly's{' '}
            <Link to={termsURL}>Terms of Service</Link>. By using gladly.io,
            tab.gladly.io, search.gladly.io, or other *.gladly.io subdomains
            (collectively, the "Website"), you agree to the terms of this
            Privacy Policy and the Terms of Service. We collectively refer to
          ...
          <p>
            ...
            Privacy Policy. We process personal data on the following legal
            bases: (1) with your consent; (2) as necessary to perform our
            agreement to provide Services; and (3) as necessary for our
            legitimate interests in providing the Services where those interests
            do not override your fundamental rights and freedoms related to data
            privacy.
          </p>
          ...
          <ul>
            <li>
              ...
              Internet Protocol address, the browser type, device information,
              and a timestamp for the request. This data is collected with
              legitimate interest to maintain and develop our product.
            </li>
            <li>
              <b>Information you provide to us: </b>
              We save information related to your behavior on Gladly, such as
              the the number tabs you open with Tab for a Cause, which charity
              partners you support, your account settings, and the users you
              refer to Tab for a Cause or Search for a Cause. In order to be
              able to save your profile and the settings associated with it, we
              ask you to log in and provide certain personal information, such
              as an email address. These are all essential data for providing
              our Services.
            </li>
            <li>
            ...
            <li>
              <p>
                ...
                When you use our Services, third parties that provide
                advertising, to the Services, may collect or receive information
                about you including through the use of cookies. These third
                parties may use your information to provide you with advertising
                that is based on your interests and to measure and analyze ad
                performance, on our Services or other websites or platforms, and
                combine it with information collected across different websites,
                online services, and other devices. These third parties' use of
                your information will be based on their own privacy policies.
                You can opt out of interest-based targeted advertising for some
              ...
              <p>
                ...
                persistent banner at the middle of the screen) upon every visit
                to the website, until and unless the user selects either "I
                accept" or "I do not accept" in the interface. Only those EEA
                Users who have selected "I accept" in this interface will have
                their personal data processed for the purpose of ad targeting,
                selection, and delivery. For any EEA User who either selects "I
                do not accept" or does not make a selection, we will only serve
              ...
              <p>
                If you are a resident of the United States of America, you can
                opt out of sharing personal information with third-party
                advertisers:{' '}
            ...
            <li>
              ...
              collected by third party companies with whom we have contracted
              when it is with legitimate interest to maintain and develop our
              product.
            </li>
          </ul>
          <p>
            You are able to request we delete your account and remove any
            personal data associated with your account. To do so, please{' '}
          ...
          <p>
            ...
            parental consent, we will immediately delete that child's
          ...
          <ul>
            ...
            <li>
              we believe it's needed to enforce our Terms of Service, or that
          ...
          <p>
            To provide our Services, we may share data with third-party
            companies (for example, software providers and cloud storage
            services) with whom we've contracted. These companies are restricted
            from using the data in any other way than to provide services to us.
          </p>
          <p>
            ...
            web search services data collection, please visit the end user
            privacy statements of CodeFuel{' '}
          ...
          <p>
            ...
            unauthorized access of data that we store.
          </p>
          <p>
            We may choose to buy or sell assets. In these types of transactions,
            user information is typically one of the transferred business
            assets. Moreover, if we, or substantially all of our assets, were
          ...
          <p>
            ...
            effect at the time such information is used. A user is bound by any
