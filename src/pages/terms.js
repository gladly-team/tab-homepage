      ...
      <div>
        ...
        <TextPageContent>
          ...
          <p>
            ...
            appearing on the Website (collectively referred to as "Content").
            This document applies to Gladly ("Gladly", Tab for a Cause", "Search
            for a Cause", "us", "our", or "we"), and by using the Website in any
            way, you agree to these Terms in their entirety. If you have any
            questions, please{' '}
          ...
          <p>
            ...
            nonprofit charity organizations ("Cause" or "Causes") that users
            care about. The following terms govern Gladly's payments to Causes:
          </p>
          <p>
            ...
            earned based on their usage of the Gladly website. Please note that
            in the case that Gladly does not receive payment from its partners
            for any reason, including but not limited to advertisement
            click-fraud, Gladly is not responsible for making any payments to
            Causes and reserves the right to modify the displayed dollar amounts
            accordingly.
          </p>
          <p>
          ...
          <p>
            ...
            be aware that they may not legally attempt to deduct from their
            taxes any amounts "raised" on Gladly and that to do so may be
            illegal in the user's tax jurisdiction.
          </p>

          <h2>2. Selection and Continuance of Causes</h2>
          <p>
            Causes that operate on the Website are selected based on whether
            they:
          </p>
          <ul>
            <li>
          ...
          <p>
            Gladly reserves all rights to choose the Causes that are to operate
            on the Website.
          </p>
          <p>
            Gladly reserves the right to remove a Cause from its website or
            discontinue all payments to a Cause at any time and without reason.
            In such a case, Gladly will evenly distribute that Cause's unpaid
          ...
          <p>
            ...
            fourteen (14) days from the date of receiving a written request from
            a verifiable member of the Cause's administration. In such a case,
          ...
          <p>
            Any photos or written content reproduced from other sources are
            photos or written content that were explicity licensed with a
            Creative Commons license for commercial use at the time of their
            obtainment.
          </p>
          <p>
            All users must agree to owning all rights to their submitted content
            and give Gladly the right to reproduce and display that content on
            the website and in all marketing material. User-submitted content is
            reproduced and displayed on good faith that the user who submitted
          ...
          <p>
            ...
            user's ownership of the material prior to complying with the
            request.
          </p>
          ...
          <p>
            ...
            distribute to eligible friends, family and other third parties
            (each, a "Referred User"). If a Referred User uses your Referral
            Link to sign up and become a user of Gladly, then the Referred User
            shall be considered a "Qualifying User" and you will be eligible for
            the referral reward. Gladly will at its sole discretion determine
            which Referred Users are approved as Qualifying Users on Gladly.
          </p>

          <div style={{ marginLeft: indentationPx }}>
            <h2>A. Sharing Referral Links</h2>
            <p>
              Referrals Links should only be used for personal and
              non-commercial purposes, and only shared with personal connections
              that will appreciate receiving these invitations.
            </p>
          </div>

          <h2>5. Disclaimers and Limitations of Liability</h2>
          <p>
            Please read this section carefully because it limits the liability
            of Gladly and its parents, subsidiaries, affiliates, related
            companies, officers, directors, employees, agents, representatives,
            partners, and licensors (collectively, the "Gladly Entities"). Each
            of the subsections below only applies up to the maximum extent
            ...
            contracts, and as a result the contents of this section may not
            apply to you. Nothing in this section is intended to limit any
          ...
          <div style={{ marginLeft: indentationPx }}>
            ...
            <p>
              ...
              THE GLADLY ENTITIES DISCLAIM ALL WARRANTIES AND CONDITIONS,
              WHETHER EXPRESS OR IMPLIED, OF MERCHANTABILITY, FITNESS FOR A
              PARTICULAR PURPOSE, OR NON-INFRINGEMENT.
            </p>
            <p>
              The Gladly Entities make no warranty and disclaim all
              responsibility and liability for: (i) the completeness, accuracy,
              availability, timeliness, security or reliability of the Website
              ...
              Website or any Content; (iii) the deletion of, or the failure to
              store or to transmit, any Content and other communications
              maintained by the Website; and (iv) whether the Website will meet
              your requirements or be available on an uninterrupted, secure, or
              error-free basis. No advice or information, whether oral or
              written, obtained from the Gladly Entities or through the Website,
            ...
            <p>
              ...
              resources. You acknowledge and agree that the Gladly Entities are
              not responsible or liable for: (i) the availability or accuracy of
              ...
              such websites or resources do not imply any endorsement by the
              Gladly Entities of such websites or resources or the content,
            ...
            <p>
              ...
              THE WEBSITE; (ii) ANY CONDUCT OR CONTENT OF ANY THIRD PARTY ON THE
              WEBSITE, INCLUDING WITHOUT LIMITATION, ANY DEFAMATORY, OFFENSIVE
              OR ILLEGAL CONDUCT OF OTHER USERS OR THIRD PARTIES; (iii) ANY
              CONTENT OBTAINED FROM THE WEBSITE; OR (iv) UNAUTHORIZED ACCESS,
            ...
            <p>
              ...
              THE AMOUNT YOU PAID GLADLY, IF ANY, IN THE PAST SIX MONTHS FOR THE
